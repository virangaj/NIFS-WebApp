...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest,String> {
    ...
    List<LeaveRequest> findAllByOrderByCreatedOnDesc();

    List<LeaveRequest> findByDivisionIdOrderByCreatedOnDesc(String division);

    @Transactional
    @Modifying
    @Query("UPDATE LeaveRequest r SET r.hodApproved = :hodApproved, r.modifiedBy = :modifiedBy, r.modifiedOn = :modifiedOn WHERE r.documentNo = :documentNo")
    ...
    @Transactional
    @Modifying
    @Query("UPDATE LeaveRequest r SET r.dirApproved = :dirApproved, r.modifiedBy = :modifiedBy, r.modifiedOn = :modifiedOn WHERE r.documentNo = :documentNo")
