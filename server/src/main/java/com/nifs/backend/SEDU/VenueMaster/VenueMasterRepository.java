...
public interface VenueMasterRepository extends JpaRepository<VenueMaster, String> {
    ...
    @Modifying
    @Query("""
            update VenueMaster v set v.venueName = :venueName, v.type = :type, v.capacity = :capacity, v.remark = :remark, v.location = :location, v.availability = :availability
    ...
    void updateVenueMaster(
            ...
            @Param("availability") String availability, @Param("venueId") String venueId);
