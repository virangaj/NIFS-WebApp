...
function VerticalMainNavbar() {
    ...
    return (
        <>
            <div className='fixed left-0 w-48 top-[2vh] invisible md:visible main-nav-bg ml-4 rounded-l-3xl transition delay-150 duration-300 ease-in-out'>
            ...
            <div className='fixed left-0 w-24 top-[2vh] visible md:invisible main-nav-bg ml-2 rounded-l-3xl transition delay-150 duration-300 ease-in-out'>
