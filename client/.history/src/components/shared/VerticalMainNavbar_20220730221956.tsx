...
function VerticalMainNavbar() {
    ...
    return (
        <div className='fixed left-0 top-0 w-40 bg-blue-400 rounded-l-lg'>
            <div className='bg-red-400 h-[100vh] w-32 flex flex-col items-center py-10 ml-10 overflow-hidden'>
