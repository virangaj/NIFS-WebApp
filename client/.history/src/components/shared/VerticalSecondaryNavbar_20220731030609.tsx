...
function VerticalSecondaryNavbar(props: any) {
    ...
    return (
        <div className='fixed left-0 w-72 top-[2vh] sec-nav-bg rounded-l-3xl'>
                        ...
                        {content.routes.map((page: any, i: number) => (
                            isAdmin ? <Link to={page.link} key={i}>
                                <div className='flex items-center'>
                                    <img src={page.img} alt={page.title} className={location.pathname === page.link ? 'w-10 bg-blue-300/30 rounded-xl p-1' : 'w-10'} />
