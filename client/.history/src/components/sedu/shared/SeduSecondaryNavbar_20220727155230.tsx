            ...
            <Box sx={{ width: '90%' }} className="secondary-navbar nav-flex-section">
                ...
                <div className='nav-flex-inside'>
                    <div className='nav-flex-section'>
                        ...
                        <Link to="sedu/booking"><button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/fluency/50/000000/available-updates.png" alt='update' /></span> Update Event Material</button>
                        </Link>         <Link to="sedu/booking"><button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/color/50/000000/qr-code--v1.png" alt='qr' /></span> Quick Response Code</button>
                        </Link>             <Link to="sedu/booking"><button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/fluency/50/000000/documents.png" alt='upload doc' /></span> Project Proposal</button>
                        </Link>                <Link to="sedu/booking"><button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/fluency/50/000000/search.png" alt='search' /></span>Material Search</button>
                        </Link>
                    </div>
                ...
                <div className='nav-flex-inside'>
                    <div className='nav-flex-section'>
                        <Link to="sedu/booking"><button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/cute-clipart/50/000000/load-from-file.png" alt='report' /></span> SEDU Report Generator</button>
                        </Link>
                    </div>
                    <div className='nav-title-section'>
