        ...
        <Box sx={{ width: '90%' }} className="secondary-navbar nav-flex-section">
            ...
            <div className='nav-flex-inside'>
                <div className='nav-flex-section'>
                    ...
                    <button className='nav-link'><span className='nav-icon'><img src="https://img.icons8.com/fluency/48/000000/available-updates.png" alt='update' /></span> Update Event Material</button>
