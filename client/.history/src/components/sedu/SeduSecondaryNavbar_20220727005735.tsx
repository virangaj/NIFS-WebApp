        ...
        <Box sx={{ width: '90%' }} className="secondary-navbar nav-flex-section">
            ...
            <div className='nav-flex-inside'>
                <div className='nav-flex-section'>
                    ...
                    <button className='nav-link'><span className='nav-icon'><FaHome /></span> Participant Master</button>
                </div>
            ...
            <div className='nav-flex-inside'>
                <div className='nav-flex-section'>
                    ...
                    <button className='nav-link'><span className='nav-icon'><FaHome /></span> Quick Response Code</button>
