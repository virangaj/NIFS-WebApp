...
function SeduMainPage() {
	...
	return (
		...
		<div >
			...
			<div className='absolute left-[425px] top-[2vh] bg-body-content-bg rounded-3xl overflow-y-scroll pl-10 pt-8 pr-4 pb-4 custom-scroll backdrop-blur-sm bg-black/30'>
