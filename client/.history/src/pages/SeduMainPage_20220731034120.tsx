...
function SeduMainPage() {
	...
	const [onClose, setOnClose] = useState(location.split('/')[1]);
	...
	return (
		...
		<div >
			...
			<div className='fixed left-[425px] top-[2vh] bg-body-content-bg rounded-3xl overflow-y-scroll pl-10 pt-4 pr-4 pb-4 custom-scroll'>
				<div className='flex justify-end mb-2'>
					<Link to={onClose}>
						<HiX className='w-6 h-6 bg-blue-500/40 rounded-full cursor-pointer p-1 hover:bg-red-400 ' />
					</Link>
				</div>
				<Routes>
