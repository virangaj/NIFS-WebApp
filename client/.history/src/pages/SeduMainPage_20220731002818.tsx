...
function SeduMainPage() {
	...
	return (
		...
		<div >
			...
			<div className='absolute left-[425px] top-[2vh] bg-body-content-bg w-[75vw] h-[96vh] rounded-3xl overflow-y-scroll'>
				<div className='absolute w-[300px] top-[-100px] right-[-100px]'>
