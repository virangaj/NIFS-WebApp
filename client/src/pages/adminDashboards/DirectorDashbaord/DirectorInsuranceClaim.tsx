...
const DirectorInsuranceClaim = () => {
  ...
  const sendApprove = () => {
    ...
    setLoading(true);
    setTimeout(() => {
      InsuranceClaimService.sendDirApproval(
        selectedData,
        auth?.user?.token,
        ...
        .then((res) => {
          if (res.data) {
            toast.success("Insurance Claim is Confirmed");
          } else {
  ...
  const sendReject = () => {
    ...
    setTimeout(() => {
      InsuranceClaimService.sendDirApproval(
        ...
        .then((res) => {
          if (res.data) {
            toast.warning("Insurance Claim is Declined");
          } else {
            toast.error("Request cannot be performed");
          }
        })
...
export default DirectorInsuranceClaim;
