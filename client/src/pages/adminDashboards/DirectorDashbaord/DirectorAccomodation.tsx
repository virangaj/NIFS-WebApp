...
const DirectorAccomodation = () => {
  ...
  const sendApprove = () => {
    ...
    setLoading(true);
    setTimeout(() => {
      AccomodationService.sendDirectorApproval(
        selectedData,
        auth?.user?.token,
        ...
        .then((res) => {
          if (res.data) {
            toast.success("Accomodation Request is Confirmed");
          } else {
  ...
  const sendReject = () => {
    ...
    setTimeout(() => {
      AccomodationService.sendDirectorApproval(
        ...
        .then((res) => {
          if (res.data) {
            toast.warning("Accomodation Request is Declined");
          } else {
            toast.error("Request cannot be performed");
          }
        })
...
export default DirectorAccomodation;
