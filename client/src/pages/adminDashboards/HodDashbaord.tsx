...
import HODWorkRequest from "./hodDashboards/HODWorkRequest";
import HODLeaveRequest from "./hodDashboards/HODLeaveRequest";
import HODOverTime from "./hodDashboards/HODOverTime";
import HODPaymentRequest from "./hodDashboards/HODPaymentRequest";
export function PageRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* common */}
      <Route path={RouteName.WorkRequest} element={<HODWorkRequest />} />

      <Route path={RouteName.LeaveRequest} element={<HODLeaveRequest />} />

      <Route path={RouteName.OverTime} element={<HODOverTime />} />

      <Route path={RouteName.PaymentRequest} element={<HODPaymentRequest />} />
